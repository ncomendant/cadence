...
public class BlockType {
    ...
    public static readonly BlockType UP = new BlockType(KeyCode.UpArrow, "U", -1f);
    public static readonly BlockType LEFT = new BlockType(KeyCode.LeftArrow, "L", -2f);
    public static readonly BlockType DOWN = new BlockType(KeyCode.DownArrow, "D", -3f);
    public static readonly BlockType RIGHT = new BlockType(KeyCode.RightArrow, "R", -4f);
